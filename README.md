...
Please review the while code base make sure that nothing links to another business that is not associated with Neighborhood Cutz or North Code LLC. 

links to booksy and instagram are okay for now. 

But any links to other business or that specifys that this webiste belongs or was built by another business remove it and change it for North Code LLC. 
